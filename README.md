...
* **Motor de Busca Avançado:** Pesquisa cruzada (Nome do Projeto ou Área Temática) com ignorância de acentos e capitalização, otimizada por *Debounce* para não travar a interface durante a digitação.
...
* **Acessibilidade (WCAG):** Navegação por teclado suportada e paleta de cores ajustada para leitura confortável e contraste seguro, inclusive no Modo Escuro.
